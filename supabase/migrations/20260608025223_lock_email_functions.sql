-- Lock down SECURITY DEFINER email queue helpers: pin search_path and
-- restrict EXECUTE to service_role only. These are called from server
-- routes using the admin client and must never be exposed to anon/authenticated.
