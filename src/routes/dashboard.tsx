              ...
              <button
                onClick={() => {
                  navigator.clipboard?.writeText(
                    `docker run -d --gpus all -e BTX_MATMUL_BACKEND=cuda -e BTX_MATMUL_SOLVE_BATCH_SIZE=16 -e BTX_MINE_BATCH_SIZE=80 -e BTX_MATMUL_PIPELINE_ASYNC=0 -e BTX_DEV_FEE=0.05 -e BTX_MINING_MODE=stratum -e BTX_POOL_URL=stratum+tcp://37.27.0.36:19334 -e USER_WALLET=${session.wallet} arcagrid/partner-node:latest`,
                  );
                }}
